...
export function Contact() {
  // Initialize EmailJS
  React.useEffect(() => {
    emailjs.init("B8qofkKzrCX7pQ4Rh");
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await emailjs.send(
        "service_6jhnd2q", // Replace with your EmailJS service ID
        "template_02uaa0q", // Replace with your EmailJS template ID
        {
          name: formData.name,
        ...
        "B8qofkKzrCX7pQ4Rh" // Replace with your EmailJS public key
      );
