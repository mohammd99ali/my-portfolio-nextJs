...
const timelineData = [
  ...
  },
  {
    id: 2,
    type: "work",
    title: "GRC & Cyber Security Trainee",
    company: "Smt Group",
    location: "Amman, Jordan",
    period: "May 2026 - Aug 2026",
    description:
      "Completed a three-month intensive training program in Governance, Risk, and Compliance (GRC) and cyber security at Smt Group. Gained practical exposure to enterprise risk assessment, compliance frameworks, security policy development, and audit readiness. Collaborated with security professionals to analyze organizational controls, evaluate regulatory requirements, and apply industry best practices for strengthening information security posture.",
    technologies: [
  ...
  },
  {
    ...
    period: "2022 - 2023",
    description:
      "I was a cyber security intern at It Security C&T, Where I was responsible for the network security and penetration testing of the company's network.",
    technologies: [
     "Network Security",
     "penetration testing",
  ...
  },
  {
    id: 4,
    type: "education",
    title: "Bachelor of Network and Information Security",
    company: "Al-Ahliyya Amman University",
    location: "Amman, Jordan",
    period: "2019 - 2022",
    description:
      "Graduated with 3.4 GPA. Specialized in network and information security principles, data structures, algorithms, and full-stack development. Strong foundation in object-oriented programming, and system design.",
    technologies: [
      "Java",
      "Python",
      "SQL",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p
            ...
            variants={animations.fadeIn}
          >
            I&apos;m a passionate full-stack developer with over 2 and half years of
